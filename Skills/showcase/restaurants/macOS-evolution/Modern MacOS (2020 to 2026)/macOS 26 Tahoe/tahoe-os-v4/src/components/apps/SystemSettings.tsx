            ...
            {currentTab === 'Wallpaper' && (
              <div className="flex flex-col h-full">
                ...
                <div className="grid grid-cols-3 gap-6 pb-8">
                  ...
                  <div 
                    className={`relative rounded-2xl overflow-hidden cursor-pointer border-4 transition-all ${systemState.wallpaperUrl === 'https://github.com/AashmanShukla3223/Antigravity-and-OpenCode-CLI-Prompts-and-Skills/releases/download/v1.0.9/Halla.Bol.mp4' ? 'border-blue-500 scale-[1.02]' : systemState.dynamicWallpaperEnabled ? 'border-white/10 hover:border-white/30' : 'border-white/5 opacity-40'}`}
                    onClick={() => {
                      if (systemState.dynamicWallpaperEnabled) {
                        updateSystemState({ wallpaperUrl: 'https://github.com/AashmanShukla3223/Antigravity-and-OpenCode-CLI-Prompts-and-Skills/releases/download/v1.0.9/Halla.Bol.mp4', wallpaperType: 'video' });
                      }
                    }}
                  >
                    <video 
                      src="https://github.com/AashmanShukla3223/Antigravity-and-OpenCode-CLI-Prompts-and-Skills/releases/download/v1.0.9/Halla.Bol.mp4" 

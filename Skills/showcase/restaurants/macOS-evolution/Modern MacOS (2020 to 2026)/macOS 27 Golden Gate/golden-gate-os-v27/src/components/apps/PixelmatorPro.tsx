    ...
    <div className="flex flex-col h-full w-full bg-[#1a1a1a] text-white select-none">
      <div className="h-11 bg-[#2d2d2d] border-b border-[#3c3c3c] flex items-center px-4 gap-3 shrink-0">
        ...
        <input
          ...
          className="w-7 h-7 rounded cursor-pointer bg-transparent border border-[#444]"
        />
        ...
        <button
          onClick={handleClear}
          className="px-3 py-1.5 rounded text-xs bg-[#3c3c3c] hover:bg-[#4a4a4a] transition"
        >
          Clear
        </button>
        <button onClick={handleExport} className="px-3 py-1.5 rounded text-xs bg-blue-600 hover:bg-blue-500 transition">
          Export PNG
        </button>
      </div>
        ...
        <div className="flex-1 flex items-center justify-center bg-[#111] p-4">
          <canvas
            ...
            style={{
              ...
              filter: activeFilter !== 'none' ? `${activeFilter}(${filterIntensity}%)` : undefined,
            }}
      ...
      <div className="h-8 bg-[#2d2d2d] border-t border-[#3c3c3c] flex items-center px-4 text-xs text-gray-400 shrink-0">
        ...
        <span className="ml-auto">
          {layers.length} layers • {selectedTool}
        </span>
      </div>
    </div>
  );

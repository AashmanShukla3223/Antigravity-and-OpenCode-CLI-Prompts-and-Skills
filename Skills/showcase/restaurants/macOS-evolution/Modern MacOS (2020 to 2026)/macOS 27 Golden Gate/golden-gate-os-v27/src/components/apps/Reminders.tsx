...
import { PlusSignIcon, Tick01Icon, Calendar01Icon } from 'hugeicons-react';

export const Reminders: React.FC = () => {
  const [tasks, setTasks] = useState([
    { id: 1, text: 'Finalize macOS Golden Gate Core', completed: false },
          ...
          <AnimatePresence>
            {tasks.map((task) => (
              ...
              >
                ...
                <span
                  className={`text-lg transition-all ${task.completed ? 'text-zinc-400 line-through' : 'text-black dark:text-white font-medium'}`}
                >
                  {task.text}
                </span>
              </motion.div>

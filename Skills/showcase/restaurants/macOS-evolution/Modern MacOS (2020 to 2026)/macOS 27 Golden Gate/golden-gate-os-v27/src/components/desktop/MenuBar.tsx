...
export const MenuBar: React.FC<MenuBarProps> = ({ toggleControlCenter }) => {
  ...
  return (
    <header onClick={clearSystemErrors} className="absolute top-0 left-0 right-0 h-[30px] flex justify-between items-center px-4 text-sm text-white z-40 bg-gradient-to-b from-black/40 to-transparent pointer-events-none">

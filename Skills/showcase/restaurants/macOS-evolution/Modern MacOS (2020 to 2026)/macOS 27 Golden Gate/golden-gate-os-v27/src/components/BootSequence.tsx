...
export const BootSequence: React.FC = () => {
  ...
  useEffect(() => {
    const isInfected = localStorage.getItem('golden_gate_infected') === 'true' && systemState.isSystemInfected;
    ...
    // Play Startup Chime — handles both autoplay and large file (692KB) loading delay
    let mounted = true;

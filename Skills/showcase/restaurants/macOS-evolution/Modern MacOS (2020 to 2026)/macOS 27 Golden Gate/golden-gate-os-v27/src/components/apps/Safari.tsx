    ...
    <div className="flex flex-col h-full w-full bg-white dark:bg-zinc-950 text-black dark:text-white">
      ...
      <div className="h-14 bg-[#f6f6f6] dark:bg-zinc-900 border-b border-gray-300 dark:border-white/10 flex items-center px-4 gap-4">
        ...
        <div className="flex-1 max-w-2xl mx-auto flex flex-col items-center">
          <form onSubmit={handleSubmit} className="w-full flex items-center bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg px-3 py-1 shadow-sm relative group">
            <div className="flex items-center gap-1 absolute left-3">
              <Shield01Icon size={14} className={isProxied && !showStartPage ? "text-blue-500 hugeicon-golden-gate" : "text-gray-400"} />
        ...
        <div className="flex gap-4 ml-auto">
          <PlusSignIcon size={20} className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white cursor-pointer hugeicon-golden-gate" />
          <DashboardSquare01Icon size={20} className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white cursor-pointer hugeicon-golden-gate" />
        </div>
      </div>
          ...
          {showStartPage ? (
              ...
              <div className="max-w-4xl mx-auto pt-20 pb-20 px-6">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-500 dark:text-white/50 max-w-lg mb-8 font-medium">
                      In the last 30 days, Safari has blocked <span className="text-black dark:text-white font-bold">1,248</span> trackers from profiling you. Your digital fingerprint is shielded by Golden Gate 27 Neural Core.
                    </p>
                ...
                <div className="pt-12 border-t border-black/5 dark:border-white/5 flex flex-col items-center text-center">
                   ...
                   <p className="text-xs text-gray-400 dark:text-white/20 font-medium max-w-md">
                     Your browsing history, open tabs, and AutoFill information are encrypted and synced across your Golden Gate devices using iCloud+.
                   </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-white/60 max-w-sm text-lg font-medium mb-12 leading-relaxed">
                Security protocols in <span className="text-red-400">Apple Silicon Firewall</span> blocked this connection to ensure Golden Gate 27 system integrity.
              </p>
              <button 

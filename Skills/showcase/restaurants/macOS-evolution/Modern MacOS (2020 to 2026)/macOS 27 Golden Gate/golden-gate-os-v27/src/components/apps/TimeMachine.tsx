      ...
      {!restoring ? (
        <div className="max-w-md w-full">
          ...
          <p className="text-white/40 mb-10 font-medium">
            Select a snapshot to restore your neural workspace to a previous point in time.
          </p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-3xl p-2 mb-10">
            <div className="p-4 bg-white/10 rounded-2xl flex justify-between items-center border border-white/20">
              ...
              <span className="text-green-400 text-[10px] font-black uppercase tracking-widest bg-green-400/10 px-2 py-1 rounded-md border border-green-400/20">
                Latest
              </span>
            </div>
          </div>
        ...
        <div className="max-w-md w-full">
          ...
          <p className="text-white/40 text-xs font-black uppercase tracking-[0.3em] mb-12">
            Silicon Enclave Decrypting
          </p>

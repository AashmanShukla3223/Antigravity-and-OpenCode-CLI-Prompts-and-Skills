    ...
    const interval = setInterval(() => {
      ...
      if (p >= 100) {
        ...
        setTimeout(() => {
          ...
          setProgress(0);
          showAlert(
            'First Aid process has completed successfully. No neural corruption detected.',
            'First Aid Complete',
          );
        }, 500);
      }
        ...
        <div className="flex-1 p-12 flex flex-col items-center overflow-y-auto scrollbar-hide">
          ...
          <div className="flex justify-between w-full max-w-lg mt-12 space-y-3 flex-col">
            <div className="p-5 bg-white/5 rounded-[24px] border border-white/5 flex items-center justify-between">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-green-400 bg-green-400/10 px-3 py-1.5 rounded-xl border border-green-400/20">
                Operational
              </span>
            </div>
            <div className="p-5 bg-white/5 rounded-[24px] border border-white/5 flex items-center justify-between">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-blue-400 bg-blue-400/10 px-3 py-1.5 rounded-xl border border-blue-400/20">
                Active
              </span>
            </div>
          </div>
          ...
          {action && (
            <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-12">
              <motion.div
                ...
                className="w-full max-w-md bg-[#222] border border-white/10 rounded-[40px] p-10 flex flex-col items-center shadow-2xl"
              >
                ...
                <p className="text-white/40 text-[10px] mb-10 font-black uppercase tracking-[0.2em]">
                  Verifying volume consistency...
                </p>

...
const mockResults: SearchResult[] = [
  ...
  { id: '7', name: 'Golden Gate Wallpaper', type: 'image', icon: Image01Icon },
    ...
    if (showSpotlight) {
      ...
      if (navigator.clipboard && navigator.clipboard.readText) {
        navigator.clipboard.readText().then(text => {
          ...
          else setClipboardHistory(['https://github.com/AashmanShukla3223', 'npm run dev', 'Hello Golden Gate']);
        }).catch(() => setClipboardHistory(['https://github.com/AashmanShukla3223', 'npm run dev', 'Hello Golden Gate']));
      } else {
        const timer = setTimeout(() => {
          setClipboardHistory(['https://github.com/AashmanShukla3223', 'npm run dev', 'Hello Golden Gate']);
        }, 0);

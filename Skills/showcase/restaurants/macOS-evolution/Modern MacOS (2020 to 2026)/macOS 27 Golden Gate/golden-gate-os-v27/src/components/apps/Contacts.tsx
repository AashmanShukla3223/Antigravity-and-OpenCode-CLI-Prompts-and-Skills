    ...
    <div className="flex h-full w-full bg-white dark:bg-zinc-950 text-black dark:text-white overflow-hidden font-sans">
        ...
        <div className="flex-1 overflow-y-auto scrollbar-hide space-y-px">
          {filteredContacts.map((c) => (
            ...
            >
              ...
              <div className={`text-[10px] truncate ${selectedId === c.id ? 'text-white/80' : 'text-zinc-400'}`}>
                {c.title}
              </div>
            </div>
          ))}
      ...
      <div className="flex-1 overflow-y-auto p-12 scrollbar-hide">
        <div className="max-w-xl mx-auto flex flex-col items-center">
          <div
            className={`w-32 h-32 rounded-full ${getContactColor(selected.id)} flex items-center justify-center text-white text-4xl font-black shadow-2xl mb-6`}
          >
